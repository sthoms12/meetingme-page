...
export function SecurityFAQ({ className }: SecurityFAQProps) {
  const securityItems = [
    ...
    },
    {
      ...
      answer: "MeetingMe is built for professional transparency, not tracking. We log anonymous view counts to give you feedback, but we do not collect PII (Personally Identifiable Information), email addresses, or use cross-site tracking cookies. Your visitors remain anonymous."
    },
    {
      id: 'infrastructure',
    ...
    <div className={cn("w-full max-w-3xl mx-auto space-y-8", className)}>
      <div className="space-y-3 text-center md:text-left">
        ...
        <p className="text-muted-foreground text-sm max-w-xl">
          We built MeetingMe with a "privacy-first" architecture. Here is how we protect your professional identity.
        </p>
      </div>
